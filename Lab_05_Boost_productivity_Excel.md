...
1. Select the dropdown menu from the **Copilot** icon on the **Home** tab. From there, select the **App Skills** option.
   In the newest version, open **Copilot** from the Home ribbon, click on **Tools** withi the prompt window, and select **Agent Mode**. 
   **IF you are using Agent Mode ypu won't need to take actions like Apply, Insert to sheet etc.** .
...
1. In the opened Copilot pane, tur off/exit Agent Mode, and enter the following prompt:
